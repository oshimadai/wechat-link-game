...
const FIXED_DECK = [
  // 🔥 Fire (22 张) - hp:4 和 hp:∞ 添加功能，万能牌保持 null
  { attr: 'fire', hp: 4, score: 1, arrow: '→', abilityId: 1 },
  { attr: 'fire', hp: 4, score: 1, arrow: '→', abilityId: 2 },
  { attr: 'fire', hp: 4, score: 1, arrow: '→', abilityId: 3 },
  { attr: 'fire', hp: 4, score: 1, arrow: '↑', abilityId: 1 },
  { attr: 'fire', hp: 4, score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'fire', hp: 4, score: 1, arrow: '↓', abilityId: 3 },
  { attr: 'fire', hp: 4, score: 1, arrow: '↓', abilityId: 1 },
  ...
  { attr: 'fire', hp: '∞', score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'fire', hp: '∞', score: 1, arrow: '↓', abilityId: 3 },
  // 💧 Water (22 张)
  { attr: 'water', hp: 4, score: 1, arrow: '→', abilityId: 1 },
  { attr: 'water', hp: 4, score: 1, arrow: '→', abilityId: 2 },
  { attr: 'water', hp: 4, score: 1, arrow: '→', abilityId: 3 },
  { attr: 'water', hp: 4, score: 1, arrow: '↑', abilityId: 1 },
  { attr: 'water', hp: 4, score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'water', hp: 4, score: 1, arrow: '↓', abilityId: 3 },
  { attr: 'water', hp: 4, score: 1, arrow: '↓', abilityId: 1 },
  ...
  { attr: 'water', hp: '∞', score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'water', hp: '∞', score: 1, arrow: '↓', abilityId: 3 },
  // 🌿 Wood (22 张)
  { attr: 'wood', hp: 4, score: 1, arrow: '→', abilityId: 1 },
  { attr: 'wood', hp: 4, score: 1, arrow: '→', abilityId: 2 },
  { attr: 'wood', hp: 4, score: 1, arrow: '→', abilityId: 3 },
  { attr: 'wood', hp: 4, score: 1, arrow: '↑', abilityId: 1 },
  { attr: 'wood', hp: 4, score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'wood', hp: 4, score: 1, arrow: '↓', abilityId: 3 },
  { attr: 'wood', hp: 4, score: 1, arrow: '↓', abilityId: 1 },
  ...
  { attr: 'wood', hp: '∞', score: 1, arrow: '↑', abilityId: 2 },
  { attr: 'wood', hp: '∞', score: 1, arrow: '↓', abilityId: 3 },
  // 🌈 Wild (4 张) - 保持无功能
